...
This resource showcase `ods-results` as the source of ods-select but most of all [Huwise geo referentials](https://data.huwise.com/explore/?refine.publisher=Huwise&refine.theme=Geographical+referentials) that always propose codes and labels for each division.

`ods-results` [documentation](https://help.huwise.com/widgets/#/api/ods-widgets.directive:odsResults).
